...
DASHBOARD_GOVERNAÇA_CHANNEL    = "dashboard-governanca"
DASHBOARD_FINANCEIRO_CHANNEL   = "dashboard-financeiro"
DASHBOARD_OPERACIONAL_CHANNEL  = "dashboard-operacional"
...
CHANNEL_STRUCTURE: dict[str, list[str]] = {
    ...
    CATEGORY_ANALYTICS: [
        ...
        RESULTADOS_CHANNEL, RANKING_CHANNEL,DASHBOARD_GOVERNAÇA_CHANNEL, 
        DASHBOARD_FINANCEIRO_CHANNEL, DASHBOARD_OPERACIONAL_CHANNEL,
    ],
    CATEGORY_STAFF: [
...
CHANNEL_VIEW_ONLY: dict[str, list[str]] = {
    ...
    RESULTADOS_CHANNEL:         [],
    RANKING_CHANNEL:            [],
    DASHBOARD_GOVERNAÇA_CHANNEL:    [CONTROLLER_ROLE_NAME, ADM_ROLE_NAME],
    DASHBOARD_FINANCEIRO_CHANNEL:   [CONTROLLER_ROLE_NAME, ADM_ROLE_NAME],
    DASHBOARD_OPERACIONAL_CHANNEL:  [CONTROLLER_ROLE_NAME, ADM_ROLE_NAME],
